...
export default function CreateCourse() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <Link
        to={createPageUrl("ProfessorDashboard")}
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Set up your course basics, then add lectures and content
        </p>
      </div>
      ...
      <div className="space-y-8">
          ...
          <div className="space-y-5">
            <div>
              ...
              <Input
                ...
                className="rounded-xl border-gray-200 focus:border-[#00a98d] focus:ring-[#00a98d]/20"
              />
            </div>
            <div>
              <Label className="text-sm text-gray-600 mb-1.5 block">
            ...
            <div>
              ...
              <Textarea
                placeholder="Brief course overview (max 100 words)"
                value={form.short_description}
                onChange={(e) =>
                  updateField("short_description", e.target.value)
                }
                className="rounded-xl border-gray-200 h-20 resize-none"
              />
            </div>
            <div>
              <Label className="text-sm text-gray-600 mb-1.5 block">
              ...
              <Textarea
                ...
                className="rounded-xl border-gray-200 h-32 resize-none"
              />
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl border border-gray-100 p-6">
          ...
          <div className="flex gap-2">
            <Input
              ...
              onKeyDown={(e) =>
                e.key === "Enter" &&
                (e.preventDefault(), addToArray("tags", tagInput, setTagInput))
              }
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              {form.tags.map((tag, i) => (
                <Badge
                  key={i}
                  variant="secondary"
                  className="px-3 py-1 bg-gray-50 text-gray-600 gap-1"
                >
                  {tag}
                  <button onClick={() => removeFromArray("tags", i)}>
                    <X className="w-3 h-3" />
                  </button>
                </Badge>
              ))}
          ...
          <div className="flex gap-2">
            <Input
              ...
              onKeyDown={(e) =>
                e.key === "Enter" &&
                (e.preventDefault(),
                addToArray("learning_outcomes", outcomeInput, setOutcomeInput))
              }
              className="rounded-xl border-gray-200"
            />
            <Button
            ...
            <ul className="mt-3 space-y-2">
              {form.learning_outcomes.map((o, i) => (
                ...
                >
                  ...
                  <button
                    onClick={() => removeFromArray("learning_outcomes", i)}
                  >
          ...
          <div className="flex gap-2">
            <Input
              ...
              onKeyDown={(e) =>
                e.key === "Enter" &&
                (e.preventDefault(),
                addToArray("prerequisites", prereqInput, setPrereqInput))
              }
              className="rounded-xl border-gray-200"
            />
            <Button
            ...
            <ul className="mt-3 space-y-2">
              {form.prerequisites.map((p, i) => (
                ...
                >
                  ...
                  <button onClick={() => removeFromArray("prerequisites", i)}>
                    <X className="w-3.5 h-3.5 text-gray-400" />
                  </button>
                </li>
              ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <Input
                ...
                value={form.credits}
                onChange={(e) =>
                  updateField("credits", parseFloat(e.target.value) || 0)
                }
                className="rounded-xl border-gray-200"
              />
            </div>
        ...
        <div className="flex justify-end gap-3 pb-8">
          <Link to={createPageUrl("ProfessorDashboard")}>
          ...
          <Button
            ...
            className="bg-[#00a98d] hover:bg-[#008f77] text-white rounded-xl gap-2 px-6"
          >
            {saving ? (
